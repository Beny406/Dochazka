...
//        setUserAgentStylesheet(STYLESHEET_CASPIAN);
        Container.getInstance(DBInitiator.class).initiateDB();
        Container.getInstance(WindowService.class).getWindow(getClass(), null, "/fxml/FXMLLogin.fxml", "Login", Boolean.TRUE);
    }
